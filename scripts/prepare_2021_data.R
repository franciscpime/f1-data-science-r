...
teams1 <- json_2021[['MRData']][['RaceTable']][['Races']][['Results']][[1]][['Constructor']][['name']]
teams2 <- json_2021[['MRData']][['RaceTable']][['Races']][['Results']][[2]][['Constructor']][['name']] 
# teams <- c(team1, team2)

# ========= POSITIONS =========

positions1 <- json_2021[['MRData']][['RaceTable']][['Races']][['Results']][[1]][['position']]
positions2 <- json_2021[['MRData']][['RaceTable']][['Races']][['Results']][[2]][['position']]
...
grids1 <- json_2021[['MRData']][['RaceTable']][['Races']][['Results']][[1]][['grid']]
grids2 <- json_2021[['MRData']][['RaceTable']][['Races']][['Results']][[2]][['grid']]
# grids <- c(grid1, grid2)
